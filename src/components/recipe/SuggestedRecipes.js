import {useGetSuggested} from "../../apiService/recipeQueries";
import RecipeCard from "./RecipeCard";

export default function Suggested() {
  const payload = {page: 1, limit: 100};
  const {data: recipes, isFetched} = useGetSuggested(payload);

  if (recipes?.count === 0 && isFetched && isFetched)
    return (
          ...
          <div className="flex flex-col w-full mb-6 lg:justify-between lg:flex-row md:mb-8">
            <div className="flex items-center mb-5 md:mb-6 group lg:max-w-xl">
              ...
              <h2 className="font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl">
                <span className="inline-block mb-2">Suggested Recipes</span>
